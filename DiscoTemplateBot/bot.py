...
from DiscoTemplateBot import events
...
class DiscordBot:
    ...
    async def emit(self, data):
        ...
        from DiscoTemplateClient.consumers import ClientConsumer
    ...
    def import_commands(self, directory="commands"):
        ...
        try:
            ...
            for file_name in command_files:
                ...
                try:
                    module = importlib.import_module(module_name, 'DiscoTemplateBot.commands')
